...
function Heading() {
	...
	return (
		<div className="relative ">
			...
			<header className="  font-semibold text-[10rem] text-center ">
				NOTES
			</header>
			<section className="w-full py-12 md:py-24 lg:py-32">
				<div className="container space-y-8 px-4 md:px-6 flex flex-col items-center justify-center space-y-4 text-center">
